sweet version 0.3.3.1 is now available from:
...
sweet data directory (listed below) and delete everything except the wallet.dat and sweet.conf

Linux : ~/.sweet/

Windows : %appdata%\sweet
...
Added support for sweet URIs in QT wallet.
...
- `722c5dc` Change strings to sweet (uppercase) and other miscellaneous fixes
- `18993f7` Correct translatable string from Bitcoin to sweet
- `a0cb315` Remove duplicate spaces from a string
- `648fc59` Add an option to open the sweet.conf in the default editor
- `80dbe2e` Add a notice when selecting edit config in QT
- `02d42ae` Fix Opening on OSX
- `4898c94` sweet-Qt (Windows only): extend Resource File
...
- `0142107` Change Window title to "sweet - Wallet" / misc related renames
...
- `f687b68` Add support for opening sweet: URIs directly.
...
- `c5c281a` Rename project to sweet-qt
...
- `ca2ae7a` Rename rpcuser from bitcoinrpc --> sweetrpc in message dialog
