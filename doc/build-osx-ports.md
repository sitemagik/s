Copyright (c) 2012-2013 sweet Developers
...
=========================================
How to build sweetd and sweet-Qt on 10.8
...
4.  Clone the github tree to get the source code
	...
	git clone https://github.com/sweetFoundation/sweet.git
...
3.  Use Qt Creator to build the project
		...
		Double-click sweet/bitcoin-qt.pro to open Qt-Creator
...
2.  Copy sweet-Qt.app and run macdeployqt to bundle required libraries

		mkdir deploy
		cp -r build-bitcoin-qt-Desktop-Release/sweet-Qt.app/ deploy/sweet-Qt.app/
		sudo macdeployqt deploy/sweet-Qt.app/

3.  Fix a dependency path

		install_name_tool -change "/opt/local/lib/db48/libdb_cxx-4.8.dylib" "@executable_path/../Frameworks/libdb_cxx-4.8.dylib" deploy/sweet-Qt.app/Contents/MacOS/sweet-Qt

4.  Compress sweet-Qt.app into a zip

		Right-click on sweet-Qt.app and click Compress