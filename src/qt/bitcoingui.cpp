 ...
 * The sweet Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("sweet") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    setWindowIcon(QIcon(":icons/sweet"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a sweet address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/sweet"), tr("&About sweet"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/sweet"), tr("Show/Hide &sweet"), this);
    toggleHideAction->setToolTip(tr("Show or hide the sweet window"));
    ...
    editConfigAction->setToolTip(tr("Edit the sweet.conf file in the default text editor"));
...
#ifndef Q_OS_MAC
            setWindowIcon(QIcon(":icons/sweet_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/sweet_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("sweet client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide sweet"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to sweet network", "", count));
}
