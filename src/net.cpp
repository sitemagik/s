...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "sweet " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are sweet dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.sweet.com", "dnsseed.sweet.com"},
    {"dnsseed.sweetfoundation.org", "dnsseed.sweetfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.sweet.com", "tseed.sweet.com"},
    {"testnet-seed.sweet.mitchellcash.com", "testnet-seed.sweet.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for sweet, sweetfoundation, xpydev
...
void StartNode(void* parg)
{
    ...
    // sweet: mint proof-of-stake blocks in the background
